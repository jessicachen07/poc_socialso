...
public class ServerAuthHandler implements GoogleApiClient.ServerAuthCodeCallbacks {
    ...
    public ServerAuthHandler(Activity activity, Handler handler) {
        mActivity = activity;
    ...
    public CheckResult onCheckServerAuthorization(String idToken, Set<Scope> scopeSet) {
        ...
        if (true) {
            ...
            serverScopeSet.add(new Scope("https://www.googleapis.com/auth/userinfo.profile"));
...
/*            try {
    ...
    public boolean onUploadServerAuthCode(String idToken, String serverAuthCode) {
        ...
        //((TextView) mActivity.findViewById(R.id.token_value)).setText("Token Value: " + serverAuthCode);
        Bundle bundle = new Bundle();
        bundle.putString("token", serverAuthCode);
