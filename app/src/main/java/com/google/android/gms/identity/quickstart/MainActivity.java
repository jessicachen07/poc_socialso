...
public class MainActivity extends FragmentActivity implements
    ...
    private static final String WEB_CLIENT_ID = "41769478586-6cmm58aq2s7uffh0qvubi8kgdaobumgo.apps.googleusercontent.com";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mToken = (TextView) findViewById(R.id.token_value);
        ...
        Handler mUIHandler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                mToken.setText("Token:" + msg.getData().getString("token"));
            }
        };
    ...
    private class RetrieveTokenTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String scopes = "oauth2:server:client_id:41769478586-6cmm58aq2s7uffh0qvubi8kgdaobumgo.apps.googleusercontent.com:api_scope:https://www.googleapis.com/auth/userinfo.profile";
            String token = null;
            try {
